...
#SBATCH --output=/home/e/e0968951/fyp/Surgical-SAM-2/shell/logs/vos_2018_efp2_%j.out
#SBATCH --error=/home/e/e0968951/fyp/Surgical-SAM-2/shell/logs/vos_2018_efp2_%j.err
...
/home/e/e0968951/fyp/fyp_env/bin/python tools/vos_inference.py \
  ...
  --input_mask_dir ./dataset/endovis_2018/val/rgb_VOS/Annotations_vos_instrument \
  --base_video_dir ./dataset/endovis_2018/val/JPEGImages \
  --gt_root ./dataset/endovis_2018/rgb_Annotations \
  --gpu_id 0 \
