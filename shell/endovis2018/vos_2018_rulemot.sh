#!/bin/bash
#SBATCH --job-name=vos_2018_rulemot
#SBATCH --output=/home/e/e0968951/fyp/Surgical-SAM-2/shell/endovis2018/logs/vos_2018_rulemot_%j.out
#SBATCH --error=/home/e/e0968951/fyp/Surgical-SAM-2/shell/endovis2018/logs/vos_2018_rulemot_%j.err
...
# 创建结果保存目录
mkdir -p /home/e/e0968951/fyp/Surgical-SAM-2/results/vos_2018_rulemot
...
/home/e/e0968951/fyp/fyp_env/bin/python tools/vos_inference.py \
  ...
  --output_mask_dir ./results/vos_2018_rulemot \
