...
#SBATCH --output=shell/endovis2018/logs/train_write_controller_online_rl_efp_endo18_%j.out
#SBATCH --error=shell/endovis2018/logs/train_write_controller_online_rl_efp_endo18_%j.err
