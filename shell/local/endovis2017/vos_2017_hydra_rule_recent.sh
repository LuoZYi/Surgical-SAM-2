...
#SBATCH --output=shell/local/endovis2017/logs/vos_2017_hydra_rule_recent_%j.out
#SBATCH --error=shell/local/endovis2017/logs/vos_2017_hydra_rule_recent_%j.err
