...
#SBATCH --output=shell/local/endovis2017/logs/vos_2017_efp_sam2_%j.out
#SBATCH --error=shell/local/endovis2017/logs/vos_2017_efp_sam2_%j.err
...
LOG_OUT="${LOG_DIR}/vos_2017_efp2_sam2.out"
LOG_ERR="${LOG_DIR}/vos_2017_efp2_sam2.err"
