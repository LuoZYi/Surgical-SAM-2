...
#SBATCH --output=shell/local/endovis2017/logs/vos_2017_hydra_efp_write_gate_%j.out
#SBATCH --error=shell/local/endovis2017/logs/vos_2017_hydra_efp_write_gate_%j.err
