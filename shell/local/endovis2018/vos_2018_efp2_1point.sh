#!/bin/bash
#SBATCH --job-name=vos_2018_efp2_1point
#SBATCH --output=shell/local/endovis2018/logs/vos_2018_efp2_1point_%j.out
#SBATCH --error=shell/local/endovis2018/logs/vos_2018_efp2_1point_%j.err
...
LOG_OUT="${LOG_DIR}/vos_2018_efp2_1point.out"
LOG_ERR="${LOG_DIR}/vos_2018_efp2_1point.err"
