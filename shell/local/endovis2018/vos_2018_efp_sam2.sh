#!/bin/bash
#SBATCH --job-name=vos_2018_efp_sam2
#SBATCH --output=shell/local/endovis2018/logs/vos_2018_efp_sam2_%j.out
#SBATCH --error=shell/local/endovis2018/logs/vos_2018_efp_sam2_%j.err
...
LOG_OUT="${LOG_DIR}/vos_2018_efp_sam2.out"
LOG_ERR="${LOG_DIR}/vos_2018_efp_sam2.err"
