...
#SBATCH --output=shell/local/endovis2018/logs/vos_2018_off_%j.out
#SBATCH --error=shell/local/endovis2018/logs/vos_2018_off_%j.err
...
LOG_OUT="${LOG_DIR}/vos_2018_off.out"
LOG_ERR="${LOG_DIR}/vos_2018_off.err"
