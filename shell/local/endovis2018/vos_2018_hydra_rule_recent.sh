#!/bin/bash
#SBATCH --job-name=vos_2018_hydra_rule_recent
#SBATCH --output=shell/local/endovis2018/logs/vos_2018_hydra_rule_recent_%j.out
#SBATCH --error=shell/local/endovis2018/logs/vos_2018_hydra_rule_recent_%j.err
...
LOG_OUT="${LOG_DIR}/vos_2018_hydra_rule_recent.out"
LOG_ERR="${LOG_DIR}/vos_2018_hydra_rule_recent.err"
