#!/bin/bash
#SBATCH --job-name=vos_2018_hydra_efp_write_gate
#SBATCH --output=shell/local/endovis2018/logs/vos_2018_hydra_efp_write_gate_%j.out
#SBATCH --error=shell/local/endovis2018/logs/vos_2018_hydra_efp_write_gate_%j.err
...
LOG_OUT="${LOG_DIR}/vos_2018_hydra_efp_write_gate.out"
LOG_ERR="${LOG_DIR}/vos_2018_hydra_efp_write_gate.err"
