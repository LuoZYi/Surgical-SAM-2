#!/bin/bash
#SBATCH --job-name=vos_seq2_efp2
#SBATCH --output=/home/e/e0968951/fyp/Surgical-SAM-2/shell/logs/vos_seq2_efp2_%j.out
#SBATCH --error=/home/e/e0968951/fyp/Surgical-SAM-2/shell/logs/vos_seq2_efp2_%j.err
...
mkdir -p /home/e/e0968951/fyp/Surgical-SAM-2/results/debug_seq2_efp2
...
/home/e/e0968951/fyp/fyp_env/bin/python tools/vos_inference.py \
  --sam2_cfg configs/sam2.1/sam2.1_hiera_s.yaml \
  --sam2_checkpoint ./checkpoints/sam2.1_hiera_s_endo18.pth \
  --output_mask_dir ./results/debug_seq2_efp2 \
  --input_mask_dir ./dataset/endovis18_debug/train/VOS/Annotations_vos_instrument \
  --base_video_dir ./dataset/endovis18_debug/train/JPEGImages \
  --gt_root ./dataset/endovis18_debug/train/Annotations \
  --gpu_id 0 \
